...
public class Fbo {
	...
	private void initialiseFrameBuffer(int type) {
		...
		if(multisampleAndMultiTarget) {
			colourBuffer = createMultiplesampleColourAttachment(GL30.GL_COLOR_ATTACHMENT0);
			colourBuffer2 = createMultiplesampleColourAttachment(GL30.GL_COLOR_ATTACHMENT1);
		}else {
	...
	private int createMultiplesampleColourAttachment(int attachment) {
